...
@section('content')
    <div class="max-w-4xl mx-auto">
        <h2 class="text-3xl font-bold text-white mb-2">Tambah Penjualan Baru</h2>
        <p class="text-gray-400 mb-6">Masukkan data penjualan TikTok baru ke dalam sistem</p>
